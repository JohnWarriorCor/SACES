...
import { Condicion3Service } from '../../../services/condicion3.service';
...
export class CondicionTresComponent implements OnInit {
  ...
  public archivoForm5 = new FormGroup({
   ...
   public archivoForm6 = new FormGroup({
    ...
    // CARGA DE ARCHIVOS A FIRESTORE ASPECTO 7
  public mensajeArchivo7 = 'No hay un archivo seleccionado';
  ...
  constructor(private firebaseStorage: CargarArchivoService, public prop: PropiedadIntelectualService, public foot: PropiedadIntelectualService, private headerTitleService: TituloService, public nav: NavbarService, private modalService: NgbModal) { }
  openSm3(content) {
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.cond3.archivoAspecto1 = this.URLPublica1;
            return [this.URLPublica1, this.finalizado1, this.cond3.archivoAspecto1];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.cond3.archivoAspecto2 = this.URLPublica2;
            return [this.URLPublica2, this.finalizado2, this.cond3.archivoAspecto2];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.cond3.archivoAspecto3 = this.URLPublica3;
            return [this.URLPublica3, this.finalizado3, this.cond3.archivoAspecto3];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje4 === 100) {
        setTimeout(() => {
          referencia4.getDownloadURL().subscribe((URL) => {
            ...
            this.cond3.archivoAspecto4 = this.URLPublica4;
            return [this.URLPublica4, this.finalizado4, this.cond3.archivoAspecto4];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje5 === 100) {
        setTimeout(() => {
          referencia5.getDownloadURL().subscribe((URL) => {
            ...
            this.cond3.archivoAspecto5 = this.URLPublica5;
            return [this.URLPublica5, this.finalizado5, this.cond3.archivoAspecto5];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje6 === 100) {
        setTimeout(() => {
          referencia6.getDownloadURL().subscribe((URL) => {
            ...
            this.cond3.archivoAspecto6 = this.URLPublica6;
            return [this.URLPublica6, this.finalizado6, this.cond3.archivoAspecto6];
          });
        }, 5000);
      }
    });
  ...
  public cambioArchivo7(event) {
    if (event.target.files.length > 0) {
      ...
      for (let i = 0; i < event.target.files.length; i++) {
        ...
        this.datosFormulario7.append('archivo7', event.target.files[i], event.target.files[i].name);
      }
    } else {
  ...
  subirArchivo7() {
    ...
    const referencia7 = this.firebaseStorage.referenciaCloudStorage(this.nombreArchivo7);
    const tarea7 = this.firebaseStorage.tareaCloudStorage(this.nombreArchivo7, archivo7);

    // Cambia el porcentaje
    tarea7.percentageChanges().subscribe((porcentaje7) => {
      ...
      if (this.porcentaje7 === 100) {
        setTimeout(() => {
          referencia7.getDownloadURL().subscribe((URL) => {
            ...
            console.log(this.URLPublica7);
            this.finalizado7 = true;
            this.cond3.archivoAspecto7 = this.URLPublica7;
            return [this.URLPublica7, this.finalizado7, this.cond3.archivoAspecto7];
          });
        }, 5000);
      }
    });
