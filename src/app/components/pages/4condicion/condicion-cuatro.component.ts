...
import { Condicion4Service } from '../../../services/condicion4.service';
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.cond4.archivoAspecto1 = this.URLPublica1;
            return [this.URLPublica1, this.finalizado1, this.cond4.archivoAspecto1];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.cond4.archivoAspecto2 = this.URLPublica2;
            return [this.URLPublica2, this.finalizado2, this.cond4.archivoAspecto2];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.cond4.archivoAspecto3 = this.URLPublica3;
            return [this.URLPublica3, this.finalizado3, this.cond4.archivoAspecto3];
          });
        }, 5000);
      }
    });
