...
import { Condicion6Service } from '../../../services/condicion6.service';
      ...
      if (this.porcentaje1 === 100) {
        setTimeout(() => {
          referencia1.getDownloadURL().subscribe((URL) => {
            ...
            this.cond6.archivoAspecto1 = this.URLPublica1;
            return [this.URLPublica1, this.finalizado1, this.cond6.archivoAspecto1];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje2 === 100) {
        setTimeout(() => {
          referencia2.getDownloadURL().subscribe((URL) => {
            ...
            this.cond6.archivoAspecto2 = this.URLPublica2;
            return [this.URLPublica2, this.finalizado2, this.cond6.archivoAspecto2];
          });
        }, 5000);
      }
    });
      ...
      if (this.porcentaje3 === 100) {
        setTimeout(() => {
          referencia3.getDownloadURL().subscribe((URL) => {
            ...
            this.cond6.archivoAspecto3 = this.URLPublica3;
            return [this.URLPublica3, this.finalizado3, this.cond6.archivoAspecto3];
          });
        }, 5000);
      }
    });
